 ...
 */
public class ventanaTiendas extends javax.swing.JFrame {

    /**
     * Creates new form ventanaTiendas
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaTiendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaTiendas().setVisible(true);
            }
        });
    }
